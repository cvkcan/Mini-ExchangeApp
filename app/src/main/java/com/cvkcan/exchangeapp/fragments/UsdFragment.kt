...
class UsdFragment : Fragment(), GetCurrencyRecyclerViewAdapter.Listener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        view?.findViewById<RecyclerView>(R.id.usdRecyclerView)?.layoutManager = layoutManager
        loadData()
    }
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        getCurrencyRecyclerViewAdapter?.let {
            view.findViewById<RecyclerView>(R.id.usdRecyclerView)?.adapter = it
        }
    }
                ...
                if (response.isSuccessful) {
                    ...
                    apiResponse?.let {
                        ...
                        getCurrencyRecyclerViewAdapter =
                            GetCurrencyRecyclerViewAdapter(requireContext(),listOf(it), this@UsdFragment,"USD")
